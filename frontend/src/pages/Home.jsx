  ...
  return (
    <>
      ...
      <section>
        <div className="container">
        <div className='xl:w-[470px] mx-auto'>
            <h2 className='heading text-center relative pb-5'>
              Our Great Doctors
              <span className='absolute bottom-0 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-primaryColor rounded-full'></span>
            </h2>
            <p className='text__para text-center mt-4'>World-Class Care For Everyone. Our Health System Offers Unmatched,
              Expert Health Care.
            </p>
          </div>
